...
public class DataProvider {
    ...
    static{
        ...
        addProduct("shirt103",
                "V-neck t-shirt",
                "Our pre-shrunk organic cotton t-shirt, with its slightly fitted waist and elegant V-neck is designed to flatter. Youâ€™ll want one in every color!",
                26);
        ...
        addProduct("shirt107",
                "V-neck T-shirt",
                "Our pre-shrunk organic cotton V-neck T-shirt is the ultimate in comfort and durability, with triple stitching at the collar, sleeves, and waist. So versatile youâ€™ll want one in every color!",
                28);

        addProduct("pants102",
                "Grunge skater jeans",
                "Our boy-cut jeans are for men and women who appreciate that skate park fashions arenâ€™t just for skaters.  Made from the softest and most flexible organic cotton denim.",
                75);
    ...
    public static void deleteProduct(String itemId) {
        for (int i = 0; i< productList.size();i++){
            if (productList.get(i).getProductId() == itemId){
